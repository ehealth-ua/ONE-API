...
### 2.3. При використанні підписного контенту, payload інформація виноситься в фінктивні описи ендпойнтів які використовуються для опису структур даних.
